      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "20px 16px 40px" }}>
            ...
            <div className="card" style={{ padding: 20 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12 }}>
                {[
                  ...
                  { label: "View Reports",    icon: "⚠️", action: () => setTab("reports"),  color: "#ef4444" },
                  ...
                  { label: "System Info",     icon: "⚙️", action: () => setTab("system"),   color: "#84cc16" },
                ].map(a => (
        ...
        {tab === "reports" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div className="card" style={{ padding: 20 }}>
              <div className="card-head" style={{ marginBottom: 16 }}>
                <span className="card-title">⚠️ Reports & Moderation</span>
              </div>
              {reportsLoading ? (
                <div style={{ textAlign: "center", padding: 40 }}><div className="spinner" style={{ margin: "0 auto" }} /></div>
              ) : reports.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div className="card" style={{ padding: 24 }}>
              <div className="card-head" style={{ marginBottom: 20 }}>
                <span className="card-title">⚙️ System Information</span>
              </div>
              {[
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div className="card" style={{ padding: 20 }}>
                <div className="card-head" style={{ marginBottom: 16 }}>
                  <span className="card-title">🔧 Admin Tools</span>
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
              ...
              <div className="card" style={{ padding: 20 }}>
                ...
                {[
                  ...
                  { label: "WebSocket",       value: "✅ Active",   color: "var(--success)" },
                  { label: "File Storage",    value: "✅ Available", color: "var(--success)" },
                  { label: "Open Reports",    value: stats?.open_reports > 0 ? `⚠️ ${stats.open_reports} pending` : "✅ Clear", color: stats?.open_reports > 0 ? "var(--danger)" : "var(--success)" },
                ].map(row => (
